...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .addr-content {
    ...
    flex: 1; min-height: 0; height: calc(100vh - var(--header-h) - var(--footer-h) - 80px);
  }
  .addr-panel {
...
export default function Addresses() {
  ...
  const updateAddress = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setEditModal(null);
        loadAddresses();
      } else setEditErr("Güncelleme başarısız.");
    } catch {
      showToast("Sunucu hatası", "error");
    } finally {
      setUpdating(false);
  ...
  const MODAL_PAIRS = [
    ...
    [
      ...
      { name: "longitude", label: "Boylam", placeholder: "28.9784" },
    ],
  ];
